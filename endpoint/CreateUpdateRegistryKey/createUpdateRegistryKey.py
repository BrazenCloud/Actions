...
#
class create_update_registry_key(base_action, object):
    ...
    def perform_action(self):
        self.response.name = "Create Update Registry Key"
        self.response.type = "CreateUpdateRegistryKey"
...
action = create_update_registry_key()
